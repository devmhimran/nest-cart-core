...
export function UpdateSubCategoryForm({
  ...
  useEffect(() => {
    if (subCategoryName && data && subCategoryName !== data.name) {
  ...
  }, [subCategoryName, setValue, data]);

  function onSubmit(formData: SubCategoryFormValues) {
    if (!data?.id) return;
    setIsSubmitting(true);
    toast.promise(updateSubCategoryAsync({ id: data.id, ...formData }), {
        ...
        <FieldGroup>
          <Field>
            ...
            {errors.name ? (
              ...
              <FieldDescription>Update the sub category name.</FieldDescription>
            )}
          </Field>
          ...
          <Field>
            ...
            {errors.categoryId ? (
              ...
              <FieldDescription>Choose the parent category.</FieldDescription>
            )}
          </Field>
        </FieldGroup>
      </FieldSet>
